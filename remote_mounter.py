...
def parser_data():
    ...
    parser.add_argument('-t', dest='host', default='192.168.1.169')
    parser.add_argument('-w', dest='testpath', default='/media/sdz')
    parser.add_argument('-u', dest='sshuser', default='marinara')
    parser.add_argument('-p', dest='userpass', default='marinara')
